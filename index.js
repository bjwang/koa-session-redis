...
module.exports = function (opts) {
  ...
  var clientGet = function (id){
    //logger.warn('get.token+', id)
    return new Promise(function (resolve, reject){
      client.get(id, function(error, data){
        if (error) reject(error);
        resolve(data);
      });
    })
  }
  var clientSet = function (id, data){
    return new Promise(function (resolve, reject){
      client.set(id, data, function(error, data){
        if (error) reject(error);
        resolve(data);
      });
    })
  }
  var clientDel =  function (id){
    return new Promise(function (resolve, reject){
      client.del(id, function(error, data){
        if (error) reject(error);
        resolve(data);
      });
    })
